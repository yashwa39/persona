  ...
  return (
    <div className="w-full max-w-2xl pt-6">
      <div className="mb-8 inline-block bg-p3-blue/70 px-6 py-3 -skew-x-12 shadow-[0_0_30px_rgba(0,229,255,0.2)]">
        <h1 className="skew-x-12 font-display text-4xl uppercase tracking-[0.18em] text-p3-white md:text-6xl">
          Jade&apos;s Persona
        </h1>
      </div>
          ...
          >
            ...
            >
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="relative overflow-hidden px-5 py-4 -skew-x-12 transition-all duration-150"
                style={{ clipPath: "polygon(10% 0, 100% 0, 90% 100%, 0% 100%)" }}
              >
                <span className="absolute inset-0 bg-p3-blue/80 group-hover:bg-p3-pink transition-colors duration-150" />
                <span
                  className={`relative z-10 block skew-x-12 font-display text-3xl uppercase tracking-[0.18em] ${
